		...
		<form action="/reply.do" method="post" role="form">
			<div class="box-body">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" name="title" size="50" class="form-control" maxlength='100' value="Re : ${viewDto.title }" >
					</div>
				</div>
				<div class="form-group row">
			...
			<input type="hidden" name="ref" value="${viewDto.re_ref }" />
			<input type="hidden" name="seq" value="${viewDto.re_seq }" />
			<input type="hidden" name="lev" value="${viewDto.re_lev }" />
